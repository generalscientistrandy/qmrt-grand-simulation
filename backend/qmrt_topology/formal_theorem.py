...
ADMISSIBLE TRANSPORT CLASS (Explicit Definition):
  ...
  CLARIFICATION: "Induced by Y-junction" means:
    The connection A is induced by parallel transport rules defined by 
    Y-junction branching geometry — specifically, the spinor overlap 
    formula applied at each 120° vertex.
